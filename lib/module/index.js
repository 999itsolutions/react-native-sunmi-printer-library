...
const sunmiScannerLibrary = NativeModules.SunmiScannerLibrary;
const OS_DOES_NOT_SUPPORT = 'Your OS does not support';
export const MaxPixelWidth = {
  '58mm': 384,
  '80mm': 576
};
 ...
 */
const printerInit = Platform.select({
 ...
 */
export const printSelfChecking = Platform.select({
 ...
 * @returns "58mm" | "80mm"
 */
const getPaperWidth = Platform.select({
  android: async () => {
    try {
 ...
 */
export const getPrintedLength = Platform.select({
 ...
 */
export const setFontSize = Platform.select({
 ...
 * @param {string} text
 */
export const printText = Platform.select({
 ...
 */
export const lineWrap = Platform.select({
 ...
 */
export const cutPaper = Platform.select({
 ...
 * It is only available to the desktop devices with a cutter.
 */
export const getCutPaperTimes = Platform.select({
 ...
 *
 */
export const hr = Platform.select({
 ...
 *
 */
export const printHR = Platform.select({
  android: async barType => {
    try {
 ...
 */
export const getPrinterInfo = Platform.select({
  android: async () => {
    try {
 ...
 * @param {string} base64
 */
export const sendRAWData = Platform.select({
 ...
 */
export const commitPrinterBuffer = Platform.select({
  android: () => sunmiPrinterLibrary.commitPrinterBuffer(),
  default: () => Promise.reject(OS_DOES_NOT_SUPPORT)
});
export const labelLocate = Platform.select({
  android: () => sunmiPrinterLibrary.labelLocate(),
  default: () => Promise.reject(OS_DOES_NOT_SUPPORT)
});
export const labelOutput = Platform.select({
